...
export class TopStreamsComponent implements OnInit {
  ...
  AllPosts(){
    this.postService.getAllPosts().subscribe(data=>{
      console.log("here are the all post",data);
  ...
  CheckInLikesArray(arr,username){
    return _.some(arr,{username:username})// The _.some() function is used to find whether any value in the given list matches the given condition or not.
  }
